...
// Sadece özel "s" header'ını ekle
$done({
  body: JSON.stringify(fixedBody),
  headers: {
    's': 'YMfrmvlNWxDiUN3Or5Is1WPloic1kCT+1P+0lyg5YNYGZcgZlSLukUcnp78oJj0nhFEyLKPTtro8T+j/aDZUyagqpTQ7dhw7awVKa7Paz7vAvS7Tj0qpiPECHli6UFYD3VVLdxu1FMHIVoE4lF8EsVdOYDLXcMRaoP8/rLdTwFw='
    // Diğer header'lar otomatik olarak sunucudan gelsin
  }
});
